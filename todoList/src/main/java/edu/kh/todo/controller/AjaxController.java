...
public class AjaxController {
	...
	@PostMapping("add")
	public int addTodo(
				// @RequestParam 는 일반적으로 쿼리 파라미터나 URL 파라미터에 사용
		...
		//Todo(todoNo=0, todoTitle=ㅎㅇ, todoContent=ㅎㅇㅎㅇㅎㅇㅎㅇ, complete=null, regDate=null)
		
		// 할 일 추가하는 서비스 호출 후 응답 받기
		int result = service.addTodo(todo.getTodoTitle(), todo.getTodoTitle());
