...
const getCookie = (key) => {
  ...
  // console.log(cookies); // saveId=user01@kh.or.kr; loadId=dlglgldlglgl
  
  // cookies 문자열을 배열 형태로 변환
  const cookieList = cookies.split("; ") // ["K=V, "K=V"...]
                .map( el => el.split("=") ); // ["K", "V"] ....
    
    // console.log(cookieList); ['saveId', 'user01@kh.or.kr'], ['loadId', 'dlglgldlglgl']
  ...
  for(let i=0; i < cookieList.length; i++){
      ...
      // obj["loadId"] = "dlglgldlglgl"
  }

  // console.log(obj); // {saveId: 'user01@kh.or.kr', loadId: 'dlglgldlglgl'}
