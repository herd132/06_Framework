...
JOIN BOARD_IMG bi ON C.BOARD_NO = bi.BOARD_NO
GROUP BY BT.BOARD_NAME, B.BOARD_NO, B.BOARD_TITLE, M.MEMBER_NICKNAME, 
ORDER BY COMMENT_COUNT DESC, B.BOARD_NO DESC
FETCH FIRST 1 ROWS ONLY;
	   
SELECT * FROM UPLOAD_FILE uf  ;
COMMIT;
UPDATE BOARD SET BOARD_DEL_FL = 'N'
WHERE BOARD_NO = 1999;
...
CREATE SEQUENCE SEQ_BOARD_CODE NOCACHE; -- 수행함


INSERT INTO "BOARD_TYPE" VALUES(SEQ_BOARD_CODE.NEXTVAL, '공지 게시판'); -- 수행함

INSERT INTO "BOARD_TYPE" VALUES(SEQ_BOARD_CODE.NEXTVAL, '정보 게시판'); -- 수행함

INSERT INTO "BOARD_TYPE" VALUES(SEQ_BOARD_CODE.NEXTVAL, '자유 게시판'); -- 수행함
...
VALUES(3, 1998); -- 1번 회원이 1998번 글에 좋아요를 클릭함
...
UNION
SELECT CAST(IMG_RENAME AS VARCHAR2(300))
FROM "BOARD_IMG";


-- ORA-12704: 문자 집합이 일치하지 않습니다
-- MEMBER 테이블의 PROFILE_IMG (VARCHAR2(300))
-- BOARD 테이블의 IMG_RENAME (NVARCHAR2(50))

-- /myPage/profile/20241115140956_00001.jpg
